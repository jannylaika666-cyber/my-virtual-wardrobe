    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-white px-4">
        <div className="w-full max-w-xs text-center space-y-3">
          <h1 className="text-base font-medium text-neutral-900">Check your email</h1>
          <p className="text-sm text-neutral-500">
            We sent a confirmation link to <span className="text-neutral-900">{sentTo}</span>. Click it
            to finish creating your account, then come back and sign in.
          </p>
          <Link
            href="/auth/signin"
            className="inline-block text-sm text-neutral-900 hover:underline mt-2"
          >
            Back to sign in
          </Link>
        </div>
    ...
    <div className="min-h-screen flex items-center justify-center bg-white px-4">
      <form onSubmit={handleSubmit} className="w-full max-w-xs space-y-4">
        <div className="text-center mb-2">
          ...
          <p className="text-xs text-neutral-400 mt-1">Create your account</p>
        </div>
