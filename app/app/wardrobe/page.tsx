          ...
          <div className="grid grid-cols-2 gap-3">
            {visibleItems.map((item) => (
              ...
              >
                ...
                {/* z-[100]: keeps these above anything else painted in the
                    thumbnail; same Edit/Delete design and scale used for
                    Trip and Look cards. */}
                <div className="absolute top-2 right-2 z-[100] flex flex-col gap-2">
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
                      onEditItem(item);
                  ...
                  <button
                    ...
                    title="Delete"
                    className="flex sm:opacity-0 sm:group-hover:opacity-100 w-7 h-7 items-center justify-center rounded-full bg-neutral-900 text-white hover:bg-neutral-800 disabled:opacity-50 shadow-sm transition duration-150 text-xs leading-none"
                  >
                    ×
                  </button>
                </div>
